...
function AboutUs() {
  return (
    <div className="p-6 min-h-screen flex justify-center items-center space-x-4"> {/* Added space-x-4 for horizontal spacing */}
      <div className="w-1/2 p-4 glass-effect"> {/* Glass effect for YouTube iframe */}
      ...
      <div className="w-1/2 p-4 text-center glass-effect"> {/* Glass effect for About Us */}
