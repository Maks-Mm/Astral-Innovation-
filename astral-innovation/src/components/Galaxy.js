...
/*
for oppening the console in the browser:
...
/* old version to Galaxy without usign to click mouse and inspect the console:
...
const Galaxy = () => {
    ...
    const generateGalaxy = () => {
      ...
      material = new THREE.ShaderMaterial({
        ...
        uniforms: {
          ...
          uSize: { value: 30 * renderer.getPixelRatio() },
          uHoleSize: { value: 0.15 },
          uTexture: { value: new THREE.TextureLoader().load("https://assets.codepen.io/22914/star_02.png") },
        },
      });
  ...
  return <canvas ref={canvasRef} className="webgl" style={{ width: "100vw", height: "100vh" }} />;
};
